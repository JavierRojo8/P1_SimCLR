...
def visualize_latent_space(model_checkpoint, base_model, out_dim, data_loader, device, fig_name=None):
    ...
    plt.title('Latent Space Visualization for random erasing encoder modified in using t-SNE')
...
if __name__ == "__main__":
    # Define parameters
    model_checkpoint_path = f'runs/checkpoint_4LP/data_aug_random_erasing.pth.tar' # Path to the trained model checkpoint
    figure_name = "data_aug_random_erasing"  # Name for the saved figure
    base_model = 'resnet50'
    out_dim = 128
    batch_size = 256
